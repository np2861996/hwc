	...
	<footer class="footer" data-theme="dark">
			...
			<div class="container">
				<div class="footer-main">
					<img width="200" height="282" src="https://media.touchlinefc.co.uk/haverfordwestcounty/2022/08/haverfordwest-county.png" class="logo club-logo" alt="Haverfordwest County" decoding="async" loading="lazy">					<div>
						<div itemscope="" itemtype="http://schema.org/PostalAddress"><p class="address"><span itemprop="name" class="address-name">Ogi Bridge Meadow Stadium</span> <span itemprop="streetAddress" class="address-two">Bridge Meadow Lane</span> <span itemprop="addressLocality" class="address-locality">Haverfordwest</span> <span itemprop="addressRegion" class="address-region">Pembrokeshire</span> <span itemprop="postalCode" class="address-postcode">SA61 2EX</span></p></div>
						<p>
