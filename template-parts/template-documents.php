...
<div class="">
    ...
    <div id="block-8203-2" class="block block-8203-2 block-callout after-downloads last-block">
        <div class="callout callout-default">
            ...
            <?php
            // Get bottom section button
            $bottom_section_button = get_field('hwc_documents_bottom_section_button');
            ?>

            <?php if (!empty($bottom_section_button['url'])): ?>
                <a href="<?php echo esc_url($bottom_section_button['url']); ?>" class="btn">
                    <?php
                    // Display button title or default text
